...
namespace Ar.Common.tool
{
    ...
    */
        ...
        public static HttpWebResponse CreatePostHttpResponse(string url, IDictionary<string, string> parameters,
                ...
                public static string HttpPost(string Url, string postDataStr,string md5)
                {
                    HttpWebRequest request = (HttpWebRequest)WebRequest.Create(Url);
                    request.Method = "POST";
                    request.Headers.Add("ACCESS", "TDFAPP");
                    request.Headers.Add("SIGN", md5.ToUpper());
                    request.ContentType = "application/x-www-form-urlencoded";
                ...
                public static string HttpPoste(string Url, string postDataStr)
                {
                    HttpWebRequest request = (HttpWebRequest)WebRequest.Create(Url);
                    request.Method = "POST";
                    request.ContentType = "application/x-www-form-urlencoded";
